...
def polls_list(request):
    """
    Render the polls_list.html template which lists all the currently
    available polls.
    """

    # subistitui tudo isso por @login_required.
...
def poll_detail(request, poll_id):
    """
    Render the poll_detail.html template which allows a use to vote
...
def poll_vote(request, poll_id):    
    ...
    if not poll.user_can_vote(request.user):
        messages.error(request, 'Are you crazy? You have already vote on this poll!')
